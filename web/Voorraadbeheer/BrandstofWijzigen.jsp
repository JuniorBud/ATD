			...
			<div>
				<table>
					...
					<tr>
						...
						<td><input type="text"
							name=<%=b.getBrandstofType() + b.getTankstationID() + "0"%>
							value=<%=b.getMinimaalAantalLiters()%>></td>
						<td><input type="text"
							name=<%=b.getBrandstofType() + b.getTankstationID() + "1"%>
							value=<%=b.getAantalLiters()%>></td>
				...
				<div class="button">
					<input type="submit" name="gewijzigd" value="Wijzig brandstof">
				</div>
			</div>
		</form>
	</div>
